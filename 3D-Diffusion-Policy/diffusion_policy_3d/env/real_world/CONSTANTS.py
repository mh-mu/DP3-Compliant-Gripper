...
finger_offset_positions_compliant = [0.1, 0.15]# [0.2, 0.14]# [0.1, 0.17] #[0.0675, 0.17] #[0.0725, 0.175] #[0.075, 0.18] #[0.065, 0.175] #[0.0775, 0.1845] #[0.08, 0.1875] #[0.085, 0.19] (2nd, current calibration pic) #[0.095, 0.2] (initial)
finger_offset_positions_rigid = [0.12, 0.1]
