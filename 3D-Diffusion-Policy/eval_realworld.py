...
def main(cfg: DictConfig):
    ...
    # ckpt_dir = '/home/mh2595/workspace/implicit_force_simulation/third_party/3D-Diffusion-Policy/3D-Diffusion-Policy/data/outputs/realworld_hover_10Hz-dp3_realworld-1608_seed0/checkpoints'
    ...
    # print(workspace.model.normalizer.params_dict['action']['offset'],workspace.model.normalizer.params_dict['action']['scale'])
    # exit()
    ...
    #                             # fps=5, # 5Hz
    #                             n_obs_steps=2,
    #                             n_action_steps=8,) # TODO: check if action steps is correct
    ...
    env_runner = DummyRunner(output_dir='./',
                                ...
                                n_obs_steps=2,
                                n_action_steps=8,
                                task_name='dummy') # TODO: check if action steps is correct
    ...
    # runner_log = env_runner.run(policy=policy, save_video=False, use_force=cfg['policy']['use_force'])
