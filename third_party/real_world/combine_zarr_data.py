...
if __name__ == "__main__":
    dataset_paths = [
        '/home/mh2595/workspace/implicit_force_simulation/third_party/3D-Diffusion-Policy/3D-Diffusion-Policy/data/real-world_contact_compliant_new_actions_expert.zarr'
    ]
    output_path = '/home/mh2595/workspace/implicit_force_simulation/third_party/3D-Diffusion-Policy/3D-Diffusion-Policy/data/real-world_contact_compliant_10Hz_expert.zarr'
    ...
    combined_dataset['meta/episode_ends'] = list(range(200, total_num_step + 1, 200))
