...
# zarr_path = '/home/mh2595/workspace/implicit_force_simulation/third_party/3D-Diffusion-Policy/3D-Diffusion-Policy/data/real-world_peg_rigid_five_10Hz_expert.zarr' # avoid accidental runs
zarr_path = '/home/mh2595/project/implicit_force_simulation/third_party/3D-Diffusion-Policy/3D-Diffusion-Policy/data/real-world_peg_rigid_24_10Hz_expert.zarr'
...
for array_name in data_group.array_keys():
    ...
    if isinstance(array, zarr.core.Array):
        array.resize((array.shape[0] - 200,) + array.shape[1:])
        # array.resize((1000,) + array.shape[1:])
...
new_episode_ends = list(range(200, 4801, 200))
